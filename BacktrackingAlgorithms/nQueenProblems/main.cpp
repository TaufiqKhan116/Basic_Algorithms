...
1. Explicit constraint :
    Suppose we have 8x8 checkerboard where 8 queens are to be fit. So all
...
References :
        Book => Fundamentals of Computer Algorithms by Sartaj Sahni, page-374
*/
...
class NQueen
{
  ...
  public :
    ...
    void NQueens(int k, int n)
    {
        ...
        {
            if(place(k, i)) //This is where implicit constraint is checked and if not satisfied loop exits current iteration and enters next iteration
            {
